...
import citl from './../../Images/Citlog.jpg'
		...
		<>
			...
			<div className="inner">
				<div className="image-holder">
					<img className='signc' src={citl} alt=""></img>
				</div>
				<form action="">
					...
					<div className="form-wrapper">
						<input type="number" placeholder="Otp" className="form-control dashCit"></input>
						<i className="zmdi zmdi-smartphone-lock"></i>
					</div>
					<div className="form-wrapper">
						<textarea type="text" placeholder="Address" className="form-control"></textarea>
					...
					<Link to='/CitPage'> <button className='sibt'>Register
